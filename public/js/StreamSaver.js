/* REP: https://github.com/jimmywarting/StreamSaver.js */
/* LICENSE: https://github.com/jimmywarting/StreamSaver.js/blob/master/LICENSE */

export const streamSaver = ("streamSaver",
    () => {
        "use strict";
...
export function writeFile(filename, content) {
    ...
    return new Response(content).body.pipeTo(fileStream);
}

// export function setupFileWriter(filename) {
//     const fileStream = streamSaver.createWriteStream(filename, {
//         size: undefined, // (optional) Will show progress
//         writableStrategy: undefined, // (optional)
//         readableStrategy: undefined, // (optional)
...
export class FileWriter {
    constructor(filename, size) {
        ...
        this._wr = fileStream.getWriter();
    }

    write(data) {
        return this._wr.write(data);
    }
